...
import { ChevronRight, LogOut, User, Search } from 'lucide-react';
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        {onSearchClick && (
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#CBD5E1'; e.currentTarget.style.backgroundColor = '#F1F5F9'; }}
            onMouseLeave={(e) => { e.currentTarget.style.borderColor = '#E2E8F0'; e.currentTarget.style.backgroundColor = '#F8FAFC'; }}
          >
            <Search size={14} strokeWidth={1.75} />
            <span className="search-label" style={{ whiteSpace: 'nowrap' }}>Search...</span>
            <kbd style={{
              padding: '1px 5px',
              borderRadius: 4,
              backgroundColor: '#FFFFFF',
